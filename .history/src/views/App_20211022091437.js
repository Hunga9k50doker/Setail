...
import Slider from "../views/destinations/destinationsSilder/slider";
  ...
  return (
    <Router>
      ...
      <Switch>
        ...
        {/*=================== Destinations================== */}
        {/* <Route path="/destinations/about-us">
          <AboutUs />
        </Route>
        <Route path="/destinations/our-team">
          <OurTeam />
        </Route>
        <Route path="/destinations/what-we-offer">
          <WhatWeOffer />
        </Route> */}
        {/*=================== Tours================== */}

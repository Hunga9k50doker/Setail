      ...
      <ul className="nav__list">
        <li className="nav__list-item nav__list-item-Home">
          ...
          <div className="nav__list-item-selections">
            <NavLink to="/" className="nav__list-item-selection active" activeClassName="active">
              <p>Travel Agency</p>
            </NavLink>
            ...
            <div className="nav__list-item-selection">
              ...
              <ul className="sub-menu ">
                <li className="sub-menu-item">
                  <NavLink to="/blog/right-sidebar">Right Sidebar</NavLink activeClassName="active">
                </li>
                <li className="sub-menu-item">
                  <NavLink to="/blog/left-sidebar">Left Sidebar</NavLink activeClassName="active">
                </li>
                <li className="sub-menu-item">
                  <NavLink to="/blog/without-sidebar">Without Sidebar</NavLink activeClassName="active">
                </li>
              </ul>
            </div>
            <div className="nav__list-item-selection">
              ...
              <ul className="sub-menu ">
                <li className="sub-menu-item">
                  <NavLink to="/blog/standard">Standard </NavLink activeClassName="active">
                </li>
                <li className="sub-menu-item">
                  <NavLink to="/blog/gallery">Gallery </NavLink activeClassName="active">
                </li>
                <li className="sub-menu-item">
                  <NavLink to="/blog/Navlink">NavLink</NavLink activeClassName="active">
                </li>
              </ul>
            </div>
          </div>
        ...
        <li className="nav__list-item nav__list-item-Shop">
          ...
          <div className="nav__list-item-selections">
            ...
            <div className="nav__list-item-selection">
              ...
              <ul className="sub-menu">
                <li className="sub-menu-item">
                  <NavLink to="/shop/three-columns">Three Columns </NavLink activeClassName="active">
                </li>
                <li className="sub-menu-item">
                  <NavLink to="/shop/four-columns">Four Columns </NavLink activeClassName="active">
                </li>
                <li className="sub-menu-item">
                  <NavLink to="/shop/full-width">Full Width</NavLink activeClassName="active">
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="nav__list-item-selections">
            <ul className="nav__list-item-selection sub-category">
              ...
              <li className="sub-category-item">
                <NavLink to="/elements/tour-list">Tour List</NavLink activeClassName="active">
              </li>
              <li className="sub-category-item">
                <NavLink to="/elements/tour-carousel">Tour Carousel</NavLink activeClassName="active">
              </li>
              <li className="sub-category-item">
                <NavLink to="/elements/tour-filter">Tour Filter</NavLink activeClassName="active">
              </li>
            </ul>
            <ul className="nav__list-item-selection sub-category">
              <li className="sub-category-item">Presentation</li>
              <li className="sub-category-item">
                <NavLink to="/elements/team">Team</NavLink activeClassName="active">
              </li>
              <li className="sub-category-item">
                <NavLink to="/elements/blog-list">Blog List</NavLink activeClassName="active">
              </li>
              <li className="sub-category-item">
                <NavLink to="/elements/shop-list">Shop List</NavLink activeClassName="active">
              </li>
            </ul>
            <ul className="nav__list-item-selection sub-category">
              <li className="sub-category-item">Classic</li>
              <li className="sub-category-item">
                <NavLink to="/elements/accordions">Accordions</NavLink activeClassName="active">
              </li>
              <li className="sub-category-item">
                <NavLink to="/elements/tabs">Tabs</NavLink activeClassName="active">
              </li>
              <li className="sub-category-item">
                <NavLink to="/elements/buttons">Buttons</NavLink activeClassName="active">
              </li>
            </ul>
            <ul className="nav__list-item-selection sub-category">
              <li className="sub-category-item">Typography</li>
              <li className="sub-category-item">
                <NavLink to="/elements/headings">Headings</NavLink activeClassName="active">
              </li>
              <li className="sub-category-item">
                <NavLink to="/elements/columns">Columns</NavLink activeClassName="active">
              </li>
              <li className="sub-category-item">
                <NavLink to="/elements/section-title">Section Title</NavLink activeClassName="active">
              </li>
            </ul>
          </div>
        </li>

      ...
      <ul className="nav__list">
        <li className="nav__list-item nav__list-item-Home">
          ...
          <div className="nav__list-item-selections">
            <NavLink to="/" className="nav__list-item-selection active">
              <p>Travel Agency</p>
            </NavLink>
            <NavLink to="/home/winter-holidays" className="nav__list-item-selection">
              <p>Winters Holidays</p>
            </NavLink>
            <NavLink to="/home/exotic-destinations"className="nav__list-item-selection">
        ...
        <li className="nav__list-item nav__list-item-Pages">
          ...
          <div className="nav__list-item-selections">
            <NavLink to="/pages/about-us" className="nav__list-item-selection">
              <p>About Us</p>
            </NavLink>
            <NavLink to="/pages/what-we-offer" className="nav__list-item-selection">
              <p>What We Offer</p>
            </NavLink>
            <NavLink to="/pages/our-team" className="nav__list-item-selection">
              <p>Our Team</p>
            </NavLink>
          </div>
        </li>
        <li className="nav__list-item nav__list-item-Destinations">
          ...
          <div className="nav__list-item-selections">
            <NavLink to="/destinations/list" className="nav__list-item-selection">
              <p>Destination List</p>
            </NavLink>
            <NavLink to="/destinations/slider" className="nav__list-item-selection">
              <p>Destination Slider</p>
            </NavLink>
            <NavLink to="/destinations/item" className="nav__list-item-selection">
        ...
        <li className="nav__list-item nav__list-item-Tours">
          ...
          <div className="nav__list-item-selections">
            <NavLink to="/tours/standard-list" className="nav__list-item-selection">
              <p>Standard List</p>
            </NavLink>
            <NavLink to="/tours/gallery-list" className="nav__list-item-selection">
              <p>Gallery List</p>
            </NavLink>
            <NavLink to="/tours/split-list" className="nav__list-item-selection">
              <p>Split List</p>
            </NavLink>
          </div>
        </li>
        <li className="nav__list-item nav__list-item-Blog">
          ...
          <div className="nav__list-item-selections">
            <NavLink to="/blog/masonry" className="nav__list-item-selection">
              <p>Blog Masonry</p>
            </NavLink>
            ...
            <div className="nav__list-item-selection">
              ...
              <ul className="sub-menu ">
                <li className="sub-menu-item">
                  <NavLink to="/blog/standard">Standard </NavLink>
                </li>
                <li className="sub-menu-item">
                  <NavLink to="/blog/gallery">Gallery </NavLink>
                </li>
                <li className="sub-menu-item">
                  <NavLink to="/blog/Navlink">NavLink</NavLink>
                </li>
              </ul>
            </div>
          </div>
        ...
        <li className="nav__list-item nav__list-item-Shop">
          ...
          <div className="nav__list-item-selections">
            <NavLink to="/shop/product-list" className="nav__list-item-selection">
              <p>Product List</p>
            </NavLink>
            <NavLink to="/shop/product-single" className="nav__list-item-selection">
              <p>Product Single</p>
            </NavLink>
            <div className="nav__list-item-selection">
              <p>Shop Layout</p>
          ...
          <div className="nav__list-item-selections">
            <ul className="nav__list-item-selection sub-category">
              ...
              <li className="sub-category-item">
                <NavLink to="/elements/tour-list">Tour List</NavLink>
              </li>
              <li className="sub-category-item">

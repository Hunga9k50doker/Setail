    ...
    <div className="nav">
      ...
      <ul className="nav__list">
        <li className="nav__list-item nav__list-item-Home">
          <NavLink to="#"  activeClassName="active" className="nav__list-item-title">
            Home
          </NavLink>
        ...
        <li className="nav__list-item nav__list-item-Pages">
          <NavLink to="#" className="nav__list-item-title">Pages</NavLink>
          <div className="nav__list-item-selections">
            <NavLink
              to="/pages/about-us"
              className="nav__list-item-selection"
        ...
        <li className="nav__list-item nav__list-item-Destinations">
          <NavLink to="#" className="nav__list-item-title">Destinations</NavLink>
          <div className="nav__list-item-selections">
            <NavLink
        ...
        <li className="nav__list-item nav__list-item-Tours">
          <NavLink to="#" className="nav__list-item-title">Tours</NavLink>
          <div className="nav__list-item-selections">
            <NavLink
        ...
        <li className="nav__list-item nav__list-item-Blog">
          <NavLink to="#" className="nav__list-item-title">Blog</NavLink>
          <div className="nav__list-item-selections">
            <NavLink
              to="/blog/masonry"
              className="nav__list-item-selection"
        ...
        <li className="nav__list-item nav__list-item-Shop">
          <NavLink to="/shop"className="nav__list-item-title">Shop</NavLink>
          <div className="nav__list-item-selections">
            <NavLink
        ...
        <li className="nav__list-item nav__list-item-Elements">
          <NavLink to="/elements" className="nav__list-item-title">Elements</NavLink>
          <div className="nav__list-item-selections">

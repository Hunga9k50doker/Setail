    ...
    <div class="nav__onTop">
      ...
      <ul class="nav__onTop-rightInner">
        <li class="nav__onTop-rightInner-item">
          <i class="nav__onTop-rightInner-item-socialNet fab fa-twitter"></i>
        </li>
        <li class="nav__onTop-rightInner-item">
          <i class="nav__onTop-rightInner-item-socialNet fab fa-pinterest-p"></i>
        </li>
        <li class="nav__onTop-rightInner-item">
          <i class="nav__onTop-rightInner-item-socialNet fab fa-instagram"></i>
        </li>
        <li class="nav__onTop-rightInner-item">
          <i class="nav__onTop-rightInner-item-socialNet fab fa-facebook-f"></i>
        </li>
        <li class="nav__onTop-rightInner-item">

    ...
    <div class="nav__onTop">
      ...
      <ul class="nav__onTop-rightInner">
        <li class="nav__onTop-rightInner-item">
          <i class="nav__onTop-rightInner-itemfab fa-twitter"></i>
        </li>
        <li class="nav__onTop-rightInner-item">
          <i class="nav__onTop-rightInner-itemfab fa-pinterest-p"></i>
        </li>
        <li class="nav__onTop-rightInner-item">
          <i class="nav__onTop-rightInner-itemfab fa-instagram"></i>
        </li>
        <li class="nav__onTop-rightInner-item">
          <i class="nav__onTop-rightInner-itemfab fa-facebook-f"></i>
        </li>
        <li class="nav__onTop-rightInner-item">

    ...
    <div class="nav__onTop">
      <ul class="nav__onTop-leftInner">
        ...
        <li class="nav__onTop-leftInner-item">
          ...
          <p class="nav__onTop-leftInner-item-text">
      ...
      <ul class="nav__onTop-rightInner">
        <li class="nav__onTop-rightInner-item">
          <i class="nav__onTop-rightInner-item-socialNetwork fab fa-twitter"></i>
        </li>
        <li class="nav__onTop-rightInner-item">
          <i class="nav__onTop-rightInner-item-socialNetwork fab fa-pinterest-p"></i>
        </li>
        <li class="nav__onTop-rightInner-item">
          <i class="nav__onTop-rightInner-item-socialNetwork fab fa-instagram"></i>
        </li>
        <li class="nav__onTop-rightInner-item">
          <i class="nav__onTop-rightInner-item-socialNetwork fab fa-facebook-f"></i>
        </li>
        <li class="nav__onTop-rightInner-item">
          ...
          <div class="nav__onTop-rightInner-item-langs">
            <a href="#" class="nav__onTop-rightInner-item-lang">
              VietNam
            </a>
            <a href="#" class="nav__onTop-rightInner-item-lang">
              France

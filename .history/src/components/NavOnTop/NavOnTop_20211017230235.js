    ...
    <div class="nav__onTop">
      ...
      <ul class="nav__onTop-rightInner">
        <li class="nav__onTop-rightInner-item">
          <i class="nav__onTop-rightInner-item-socailfab fa-twitter"></i>
        </li>
        <li class="nav__onTop-rightInner-item">
          <i class="nav__onTop-rightInner-item-socailfab fa-pinterest-p"></i>
        </li>
        <li class="nav__onTop-rightInner-item">
          <i class="nav__onTop-rightInner-item-socailfab fa-instagram"></i>
        </li>
        <li class="nav__onTop-rightInner-item">
          <i class="nav__onTop-rightInner-item-socailfab fa-facebook-f"></i>
        </li>
        <li class="nav__onTop-rightInner-item">
